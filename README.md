...
## Adding a Screenshot
```bash
# macOS: capture the browser window
screencapture -w media/screenshot.png
# Click the Focus Logger browser window
```
The `media/screenshot.png` will be used in this README.